    ...
    option4 = {
        ...
        series: [
            ...
            data:  webkitDep.nodes.map(function (node,idx) {
                // console.log(idx);
                node.id = idx;
                var sum_level=(webkitDep.nodes[idx].salary_lan+(webkitDep.nodes[idx].edu_lan*3)+webkitDep.nodes[idx].work_lan+webkitDep.nodes[idx].lan_level)/2.8
                node.symbolSize=sum_level;//元的大小表示这个人的平均能力水平，学历，经验，外语等
                return node;
            }),
            itemStyle: {
                normal: {
